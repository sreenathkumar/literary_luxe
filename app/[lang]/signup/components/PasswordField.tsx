...
function PasswordField() {
    ...
    return (
        <div className="relative">
            <Input id="password" type={fieldType} placeholder="create a password" name="password" className='border-accent-200 p-4 text-base text-neutral placeholder:text-neutral-300' />
            {
