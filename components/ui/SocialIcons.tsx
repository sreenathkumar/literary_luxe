...
function SocialIcons(props: React.HTMLAttributes<HTMLDivElement>) {
    return (
        <div{...props}>
            <Icon url="https://www.facebook.com/dev.sreenathkumar/" className="text-neutral-200 hover:text-accent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                </svg>
            </Icon>
            <Icon url="https://twitter.com/sreenathkumar_" className="text-neutral-200 hover:text-accent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor">
                    <path
            ...
            <Icon url="https://www.linkedin.com/in/sreenathkumar" className="text-neutral-200 hover:text-accent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Icon url="https://github.com/sreenathkumar" className="text-neutral-200 hover:text-accent">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor">
