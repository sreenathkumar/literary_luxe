...
function SocialIcons() {
    return (
        <div className="flex mt-auto gap-4 justify-center text-neutral">
            <Link href="https://www.facebook.com/dev.sreenathkumar/" target="_blank" rel="noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="fill-neutral-200">
